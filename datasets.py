...
def build_dataset(is_train, args):
    ...
    if args.data_set == 'CIFAR':
        ...
        dataset = datasets.Flowers102(args.data_path, split='train' if is_train else 'val', transform=transform, download=True)
        nb_classes = 102
    elif args.data_set == 'IMNETTE':
        dataset = datasets.Imagenette(args.data_path, split='train' if is_train else 'val', transform=transform, download=True)
        nb_classes = 10
        ...
        dataset = datasets.GTSRB(args.data_path, split='train' if is_train else 'test', transform=transform, download=True)
        nb_classes = 256
